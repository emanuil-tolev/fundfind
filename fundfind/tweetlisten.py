...
class TweetListen(object):
    ...
    def __init__(self):
        credentials = fundfind.dao.TwitterCreds.query(q='*')
    ...
    def save_lastid(self, last_proc_tweet):
        ...
        fundfind.dao.TwitterLastID.upsert(upsertthis)
        
    def get_lastid(self):
        ids = fundfind.dao.TwitterLastID.query(q='*')
            ...
            for status in mentions:
                ...
                try:
                    ...
                    if match:
                        ...
                        answer = fundfind.dao.Identifier.identify(q=q)
